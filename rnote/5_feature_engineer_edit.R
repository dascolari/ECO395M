...
path <- "/Users/davidscolari/Dropbox/grad_school/3_Spring22/datmin"

#make path to needed sub-directories
path_data <- file.path(path, "ECO395M", "data")
...
load_ercot <- read.csv(file.path(path_data, "load_ercot.csv"))

# Now weather data at the KHOU weather station
# temps in F
load_temperature = read.csv(file.path(path_data, "load_temperature.csv"))
