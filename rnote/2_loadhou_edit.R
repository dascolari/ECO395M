...
loadhou = read.csv('/Users/davidscolari/Dropbox/grad_school/3_Spring22/datmin/data/loadhou.csv')
summary(loadhou)
...
#how to set the seed for initial split
# use set.seed, set seed globally 
...
#keep this bad boy out of the loop below
loadhou = loadhou %>%
