gasoline = read.csv("/Users/davidscolari/Dropbox/grad_school/3_Spring22/ECO395M/data/gasoline.csv", header=TRUE)
head(gasoline)
...
# Yikes!
# doesn't work since you have more features than observations 
summary(lm1)
dim(X)
